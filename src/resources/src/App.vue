<template>
  ...
  >
    <div
      ...
      class="hidden lg:block top-0 left-0 z-10 lg:static absolute bg-primary w-[280px] h-screen select-none shrink-0"
    >
      <div class="flex flex-col h-full">
        <div class="flex items-center gap-4 p-4">
          ...
          <span
            class="font-semibold text-primary-contrast text-lg leading-tight"
            >ZenTrail</span
          >
        </div>
        <div class="flex flex-col flex-1 gap-4 p-2 overflow-y-auto">
            ...
            <li>
              ...
              <ul class="flex flex-col gap-1 m-0 overflow-hidden list-none">
                ...
                <li>
                  ...
                  >
                    ...
                    <Badge
                      value="3"
                      severity="contrast"
                      class="bg-primary-contrast ml-auto rounded-xl! min-w-5! h-5! font-bold! text-primary text-xs! leading-tight!"
                    />
                  </a>
                </li>
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-users"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Team</span
                    >
                ...
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-inbox"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Messages</span
                    >
                ...
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-calendar"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Calendar</span
                    >
          ...
          <ul class="flex flex-col gap-1 m-0 list-none">
            <li>
              ...
              <ul
                class="flex flex-col gap-1 m-0 mt-1 pl-0 overflow-hidden list-none"
              >
                <li>
                  <a
                    class="flex items-center gap-2 hover:bg-primary-emphasis p-3 rounded-lg text-primary-contrast transition-colors duration-150 cursor-pointer"
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-sitemap"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Overview</span
                    >
                ...
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-shield"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Security</span
                    >
                  ...
                  <ul
                    class="hidden flex flex-col gap-1 m-0 mt-1 py-0 pr-0 pl-8 overflow-y-hidden transition-all duration-400 ease-in-out list-none"
                  >
                    <li>
                      <a
                        v-styleclass="{
                      ...
                      >
                        <i
                          class="text-base! text-primary-contrast leading-none! pi pi-lock"
                        />
                        <span class="font-medium text-base leading-tight"
                          >Permissions</span
                        >
                      ...
                      >
                        ...
                        <li>
                          ...
                          >
                            <i
                              class="text-base! text-primary-contrast leading-none! pi pi-history"
                            />
                            <span class="font-medium text-base leading-tight"
                              >Audit Log</span
                            >
                    ...
                    <li>
                      ...
                      >
                        <i
                          class="text-base! text-primary-contrast leading-none! pi pi-bell"
                        />
                        <span class="font-medium text-base leading-tight"
                          >Alerts</span
                        >
                ...
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-globe"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Domains</span
                    >
                ...
                <li>
                  ...
                  >
                    <i
                      class="text-base! text-primary-contrast leading-none! pi pi-copy"
                    />
                    <span class="font-medium text-base leading-tight"
                      >Reports</span
                    >
        ...
        <div
          class="mt-auto py-2 border-primary-400 dark:border-primary-300 border-t"
        >
          <ul
            class="hidden m-0 p-2 overflow-hidden animate-duration-150 list-none"
          >
            <li>
              <a
                class="flex items-center gap-2 hover:bg-primary-emphasis p-3 rounded-lg text-primary-contrast transition-colors duration-150 cursor-pointer"
              >
                <i
                  class="text-base! text-primary-contrast leading-none! pi pi-user"
                />
            ...
            <li>
              ...
              >
                <i
                  class="text-base! text-primary-contrast leading-none! pi pi-cog"
                />
                <span class="font-medium text-base leading-tight"
                  >Settings</span
                >
            ...
            <li>
              ...
              >
                <i
                  class="text-base! text-primary-contrast leading-none! pi pi-sign-out"
                />
                <span class="font-medium text-base leading-tight"
                  >Sign Out</span
                >
          ...
          >
            ...
            <i
              class="ml-auto text-base! text-primary-contrast leading-none! pi pi-angle-up"
            />
          </a>
        </div>
      </div>
    ...
    <div class="relative flex flex-col flex-auto min-h-screen">
      ...
      >
        ...
        <div class="flex items-center gap-8">
          <i
            class="text-lg! text-surface-500 dark:text-surface-400 leading-none! cursor-pointer pi pi-bell"
          />
          <img
            src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/avatars/avatar-amyels.png"
            class="rounded-full w-8 h-8 cursor-pointer"
      ...
      <div class="flex flex-col flex-auto p-8">
        <div
          class="flex-auto bg-surface-50 dark:bg-surface-800 border-2 border-surface-200 dark:border-surface-700 border-dashed rounded-2xl"
        />
      </div>
    </div>
  </div>
