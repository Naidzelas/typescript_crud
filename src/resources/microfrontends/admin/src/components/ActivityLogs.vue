    ...
    <div class="p-6">
        ...
        <div class="bg-white dark:bg-gray-900 shadow mb-8 p-6 rounded-lg">
            ...
            <DataTable 
                ...
                :sortOrder="-1"
                filterDisplay="row"
                :globalFilterFields="['action', 'payload']"
            ...
            >
                ...
                <Column field="action" header="Action" sortable :showFilterMenu="false">
                ...
                <Column field="created_at" header="Timestamp" sortable style="width: 200px">
                    <template #body="{ data }">
        ...
        <div class="bg-white dark:bg-gray-900 shadow p-6 rounded-lg">
            ...
            <DataTable 
                ...
                :sortOrder="-1"
                filterDisplay="row"
                :globalFilterFields="['endpoint', 'method']"
                class="p-datatable-sm"
            >
                <template #empty>
                    <div class="py-8 text-center">
                ...
                <Column field="endpoint" header="Endpoint" sortable :showFilterMenu="false" style="min-width: 250px">
                    <template #filter="{ filterModel, filterCallback }">
                        <InputText 
                            v-model="filterModel.value" 
                            @input="filterCallback()" 
                ...
                <Column field="code" header="Status" sortable style="width: 100px">
                    <template #body="{ data }">
                        <Tag :value="data.code.toString()" :severity="getCodeSeverity(data.code)" />
                    </template>
                </Column>
